                    ...
                    {!isSent ? (
                        <>
                            ...
                            <button
                                ...
                                className="w-full flex items-center justify-center py-3 px-4 rounded-xl text-gray-700 bg-white border border-gray-200 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-200 font-medium transition-all shadow-sm hover:shadow-md mb-6"
                            >

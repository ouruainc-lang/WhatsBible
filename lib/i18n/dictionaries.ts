...
export const dictionaries = {
    en: {
        ...
        auth: {
            ...
            clickLink: "Click the link to sign in or sign up.",
    ...
    pt: {
        messages: {
            ...
            contentReady: "📖 *DailyWord Pronto*\n\nSua benção diária chegou!\n\nResponda *LEITURA COMPLETA* para o texto completo.\nResponda *RESUMO & REFLEXÃO* para uma reflexão.",
            ...
            noOtpMessage: "✅ Sessão de Suporte Ativa.\n\nVocê agora pode receber seu código de verificação.\n\nPor favor, retorne ao painel para solicitar o código novamente:\n{dashboardUrl}",
            trialExpiring: "⏳ *Período de Teste Acabando*\n\nSeu teste gratuito do DailyWord termina em 3 dias.\n\nPara continuar sua jornada sem interrupções, adicione um método de pagamento:\n{link}\n\nVocê pode cancelar a qualquer momento. 🙏",
        },
        ui: {
        ...
        auth: {
            ...
            signInEmail: "Continuar com Email",
            checkEmail: "Verifique seu email",
            magicLinkSent: "Enviamos um link mágico para",
            clickLink: "Clique no link para entrar ou cadastrar.",
            tryDifferent: "Tentar outro email",
    ...
    tl: {
        messages: {
            ...
            contentReady: "📖 *DailyWord Handa Na*\n\nAng iyong pang-araw-araw na biyaya ay narito na!\n\nSumagot ng *BUONG PAGBABASA* para sa buong teksto.\nSumagot ng *BUOD AT PAGNINILAY* para sa pagninilay.",
            ...
            noOtpMessage: "✅ Aktibo ang Support Session.\n\nMaaari mo nang matanggap ang iyong verification code.\n\nMangyaring bumalik sa dashboard upang hilingin muli ang code:\n{dashboardUrl}",
            trialExpiring: "⏳ *Malapit nang Matapos ang Trial*\n\nAng iyong DailyWord free trial ay magtatapos na sa loob ng 3 araw.\n\nUpang magtuloy-tuloy ang iyong paglalakbay, magdagdag ng payment method:\n{link}\n\nMaaari kang mag-cancel kahit kailan. 🙏",
        },
        ui: {
        ...
        auth: {
            ...
            subtitle: "Mag-sign in o gumawa ng account",
            signInGoogle: "Magpatuloy gamit ang Google",
            orEmail: "O magpatuloy gamit ang email",
            srEmail: "Email address",
            placeholderEmail: "pangalan@halimbawa.com",
            signInEmail: "Magpatuloy gamit ang Email",
            checkEmail: "Tignan ang iyong email",
            magicLinkSent: "Nagpadala kami ng magic link sa",
            clickLink: "I-click ang link upang mag-sign in o mag-sign up.",
            tryDifferent: "Subukan ang ibang email",
            terms: "Sa pag-click ng magpatuloy, sumasang-ayon ka sa aming",
